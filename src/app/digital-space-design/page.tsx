// sections
import { DigitalSpaceDesignView } from 'src/sections/digital-space-design/view';

// ----------------------------------------------------------------------

export const metadata = {
  title: 'ARmo',
  description: 'Learn and explore the latest in AR technology, applications, and experiences.',
  keywords:
...
export default function DigitalSpaceDesignPage() {
  return <DigitalSpaceDesignView />;
}
