...
// utils
import { serializeDateData } from 'src/utils/views-serializer';
// constants
...
export default function ImpressionView({ title, organization_id, ...other }: Props) {
  ...
  const { categories, data } = serializeDateData(date as Date[], t('analytics.impression'), isRtl);
