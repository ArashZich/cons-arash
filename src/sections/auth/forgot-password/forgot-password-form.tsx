...
import { phoneNumberChanged, statusSelector, statusChanged } from 'src/redux/slices/registration';
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      await sendVerificationCode({
        phone: convertPersianToEnglishNumber(data.phone as string) || '',
      });

      dispatch(phoneNumberChanged(convertPersianToEnglishNumber(data.phone as string) || ''));
